...
import com.generation.ecommercefarmacia.repository.CategoriaRepository;
import com.generation.ecommercefarmacia.repository.ProdutoRepository;
...
public class ProdutoController {
	...
	public ResponseEntity<Produto> post(@Valid @RequestBody Produto produto) {
		...
		if (categoriaRepository.existsById(produto.getCategoria().getId())) {
			...
			// INSERT INTO tb_produtos(nome, descricao) VALUES(?, ?);
		}
	...
	public ResponseEntity<Produto> put(@Valid @RequestBody Produto produto) {
		...
		if(produtoRepository.existsById(produto.getId())) {
			...
			// UPDATE tb_produtos SET nome = ?, descricao = ? WHERE id = ?;
		}
