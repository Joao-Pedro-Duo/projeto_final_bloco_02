package com.generation.ecommercefarmacia.service;
...
import com.generation.ecommercefarmacia.security.JwtService;
...
public class UsuarioService {
	...
	public Optional<Usuario> cadastrarUsuario(Usuario usuario) {
		...
		// Adição da verificação de maioridade (O usuário informado no cadastro deve possuir idade igual ou superior a 18 anos)
		...
		if((dataAtual - anoNascimento) < 18) {
			throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "O usuário precisa ser maior de 18 anos!", null);
		}
